...
namespace CHXD
{
    public partial class frmHoaDon : Form
    {
        ...
        private void LoadInfoHoaDon()
        {
            ...
            txtMaKhachHang.Text = Functions.GetFieldValues(str);
        ...
        {
            string sql;
            sql = "SELECT a.MaXe, b.TenXe, a.SoLuong, b.GiaBan, a.GiamGia,a.ThanhTien FROM ChiTietHoaDon AS a, XeDien AS b WHERE a.MaHoaDon = N'" + txtmahoadon.Text + "' AND a.MaXe=b.MaXe";
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                if (!Functions.CheckKey(sql))
                {
                    sql = "INSERT INTO KhachHang(MaKhachHang, Hoten, DiaChi, SoDienThoai) VALUES (N'" + txtMaKhachHang.Text.Trim() +
        ...
        private void btnin_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Cửa Hàng Xe Điện Việt Thanh";
