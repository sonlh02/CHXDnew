...
namespace CHXD
{
    public partial class frmKhachHang : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (txtmakhachhang.Text.Trim().Length == 0) //Nếu chưa nhập mã khách hàng
            {
        ...
        {
            string sql;
            if ((txtmakhachhang.Text == "") && (txthoten.Text == "") && (txtdiachi.Text == ""))
            {
            ...
            else MessageBox.Show("Có " + KhachHang.Rows.Count + "  bản ghi thoả mãn điều kiện!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
